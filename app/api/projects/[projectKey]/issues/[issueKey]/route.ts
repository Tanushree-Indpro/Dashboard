...
export async function GET(
  ...
  try {
    ...
    // Added 'issuelinks.fields' to get details of linked issues
    const fields = "summary,description,status,assignee,reporter,priority,labels,duedate,issuetype,parent,subtasks,created,updated,customfield_10016,issuelinks";
    ...
    const issue = {
      ...
      // --- NEW: Added linked issues ---
      links:
        data.fields.issuelinks?.map((link: any) => {
          const linkedIssue = link.inwardIssue || link.outwardIssue;
          // Guard against links to issues that were not returned
          ...
          return {
            ...
            description: link.inwardIssue ? link.type.inward : link.type.outward, // e.g., "is blocked by"
            key: linkedIssue.key,
